...
export function ModeSwitch({ mode, onModeChange }: ModeSwitchProps) {
  return (
    <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
      <h3 className="text-sm font-semibold text-gray-300 mb-3">Modo de Ejecución</h3>
      ...
      <div className="text-xs text-gray-400 space-y-1">
        {mode === 'naive' ? (
          <>
            <p>
              <strong className="text-gray-300">Modo Ingenuo:</strong>
            </p>
          ...
          <>
            <p>
              <strong className="text-gray-300">Modo Optimizado:</strong>
            </p>
            <ul className="list-disc list-inside space-y-0.5 ml-2">
